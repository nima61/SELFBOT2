...
dhenzaSelfbot = LINE("@mozej.com","pass")

oepoll = OEPoll(dhenzaSelfbot)
call = dhenzaSelfbot
creator = ["u282cdb458429b92b3fd7f12f5004680d"]
owner = ["u282cdb458429b92b3fd7f12f5004680d"]
admin = ["u282cdb458429b92b3fd7f12f5004680d"]
staff = ["u282cdb458429b92b3fd7f12f5004680d"]
...
def help():
    ...
    num = (num+1)
    helpMessage += "│ " + " ├──────────────\n"
    helpMessage += "│ " + " ╰───• ᴺᴵᴹᴬ ˢᴱᴸᶠ ᴮᴼᵀ™ •────\n"
    helpMessage += "╰━─────────────━ \n"
    helpMessage += "https://line.me/ti/p/~nimabotlinee\n"
    helpMessage += "♜𝑁𝐼𝑀𝐴𝑀𝐴𝑋𝐵𝑂𝑇♜"
    return helpMessage
...
def helpbot():
    ...
    num = (num+1)
    helpMessage2 += "│ " + "├──────────────\n"
    helpMessage2 += "│ " + "╰───• ᴺᴵᴹᴬ ˢᴱᴸᶠ ᴮᴼᵀ™ •────\n"
    helpMessage2 += "╰━────────────━ \n"
    helpMessage2 += "https://line.me/ti/p/~nimabotlinee\n"
    helpMessage2 += "♜𝑁𝐼𝑀𝐴𝑀𝐴𝑋𝐵𝑂𝑇♜"
    return helpMessage2
...
def helpmedia():
    ...
    num = (num+1)
    helpMessage3 += "│ " + " ├──────────────\n"
    helpMessage3 += "│ " + " ╰───• ᴺᴵᴹᴬ ˢᴱᴸᶠ ᴮᴼᵀ™ •────\n"
    helpMessage3 += "╰━────────────━ \n"
    helpMessage3 += "https://line.me/ti/p/~nimabotlinee\n"
    helpMessage3 += "♜𝑁𝐼𝑀𝐴𝑀𝐴𝑋𝐵𝑂𝑇♜"
    return helpMessage3    
                        ...
                        if cmd == "cek":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin or msg._from in staff or msg._from in mid:
                                ...
                                md+= "│╚══[ ♜𝑁𝐼𝑀𝐴𝑀𝐴𝑋𝐵𝑂𝑇♜ ]"
                                md+= " https://line.me/ti/p/~nimabotlinee"
                        	...
                        	if msg._from in owner or msg._from in admin or msg._from in staff or msg._from in mid:
                                    try:
                                        ...
                                        for i in range(len(st)):
                                            ...
                                            dhenzaSelfbot.createComment(str(sender), str(result), 'Autolike by nimabotlinee\nhttp://line.me/ti/p/~max_pv\n\nlike suport By TBP SILENTKILLER')
